...
3. Se localizan los bat y se ejecutan en el orden que estan asignados, primero el 1_calculix, se emepzara a ejecutar el procesado de los datos y se entra que esperar hasta que diga el siguiente mensaje
